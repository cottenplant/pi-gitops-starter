...
Pushing to the default branch builds an image via GitLab CI into this project's container registry
(`$CI_REGISTRY_IMAGE`); Flux image automation rolls it out. See the starter kit's `flux/` skeleton for the cluster side.
